...
class CiviCRM_For_WordPress {
  ...
  */
  ...
  public function check_permission( $args ) {
    ...
    $validPaths = array('profile', 'user', 'dashboard', 'friend', 'file', 'ajax','showevents');
  ...
  public function add_form_button( $context ) {
    ...
    if ( $screen->post_type == 'post' OR $screen->post_type == 'page' ) {
      ...
      $out         = '<a href="#TB_inline?width=480&inlineId=calendar_frontend_pages" class="button thickbox" id="add_civi" style="padding-left: 4px;" title="' . __( 'Add CiviCRM Public Pages', 'civicrm-wordpress' ) . '"><img src="' . $imageBtnURL . '" height="15" width="15" alt="' . __( 'Add CiviCRM Public Pages', 'civicrm-wordpress' ) . '" />Event Calendar</a>';
      return $context . $out;
